			...
			<section>
				<nav>
					<ul>
						...
						<li><a href="#" onclick="showDiv('nowe-zgloszenie')">Stwórz zgłoszenie</a></li>
...
<!-- 			<h2>Powiadomienia</h2>
			<section>
				<article>Powiadomienie nowa wiadomośc do zgłoszenia NR_ZGŁOSZENIA LOREM IPSUM DOLOR SIT AMET</article>
				<article>Powiadomienie nowa wiadomośc do zgłoszenia NR_ZGŁOSZENIA LOREM IPSUM DOLOR SIT AMET</article>
			</section> -->
			<div id="nowe-zgloszenie" class="section hidden">
				...
				<section>
					<form id="newTicketForm">
						...
						<input type="text" id="title" name="title" placeholder="tytuł"><br>
						<label for="description">Opis zgłoszenia:</label>
						<input type="description" id="description" name="description" placeholder="opis"><br>
